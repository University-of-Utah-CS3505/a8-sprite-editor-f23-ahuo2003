...
public slots:
    ...
    /**
     * @brief changeColorPreview changes the current color being displayed in our preview box
    ...
    /**
     * @brief eyeDropperToggled handles the event when the eydropper tool is selected
     */
